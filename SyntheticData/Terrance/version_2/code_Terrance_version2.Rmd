---
title: "Analysis for Terrance's synthesis - Version 2"
author: "Yue Xiong"
date: '2022-10-06'
output:
...
syn_data <- read.csv(file = "./SyntheticData/Terrance/version_2/syn_k2_2020-08-02_2020-08-08.csv")
# and on macos 
head(syn_data)
...
dim(bindori_dataset) == dim(syn_data)
...
```
```{r}
nrow(vars2show)  # there are 9 in total
```
...
compare(object = data.frame(D9 = syn_select_vars["D9"]),
        ...
        msel = NULL, stat = "percents", breaks = 40,
        nrow = 2, ncol = 2, rel.size.x = 1,
        utility.stats = c("pMSE", "S_pMSE"),
        cols = c("#1A3C5A","#4187BF"),
        plot = TRUE, table = TRUE)
