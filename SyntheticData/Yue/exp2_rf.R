...
load("ods_preprocess_0804.rda")
str(ods_threshold_0804)
...
#     1      2 
# 57585 202714  
ods_threshold_0804$E6 <- as.integer(ods_threshold_0804$E6)
...
ods_threshold_0804 <- ods_threshold_0804 %>% select(-all_of(cols_remove))
...
ods_threshold_0804 <- ods_threshold_0804 %>% select(-all_of(cols_rm_bd))
ncol(ods_threshold_0804)==54
nrow(ods_threshold_0804)
...
settings_default <- syn(ods_threshold_0804, method = "cart", m = 0)
...
sds_rangersample_tryout <- syn_ranger_experiment(para_weight_list, index=1, ods_threshold_0804, arg_method, arg_col)
# tryout for ranger_norm
sds_rangernorm_tryout <- syn_ranger_experiment(para_weight_list, index=2, ods_threshold_0804, arg_method, arg_col)
# tryout for ranger_normrank
sds_rangernormrank_tryout <- syn_ranger_experiment(para_weight_list, index=3, ods_threshold_0804, arg_method, arg_col)
