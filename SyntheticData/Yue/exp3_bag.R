...
sds_bagsample_tryout <- syn_bag_experiment(para_weight_list, index=1, bindori_dataset_threshold_chr, arg_method, arg_col)
# tryout for bag_norm
sds_bagnorm_tryout <- syn_bag_experiment(para_weight_list, index=2, bindori_dataset_threshold_chr, arg_method, arg_col)
# tryout for bag_normrank
sds_bagnormrank_tryout <- syn_bag_experiment(para_weight_list, index=3, bindori_dataset_threshold_chr, arg_method, arg_col)
