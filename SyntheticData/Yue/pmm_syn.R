...
syn_experiment <- function(method, index_round, method_list, bindori_dataset_threshold_chr, arg_method, arg_col) {
  ...
  write.syn(syn_dataset, filename = paste("pmm", method, "syn", sep="_"), filetype = "rda")
  message("syn done!")
}

# tryout for pmm_cart
sds_pmmcart_tryout <- syn_experiment(method="cart", index_round=2, method_list, bindori_dataset_threshold_chr, arg_method=arg_method, arg_col=arg_col)
# tryout for pmm_rf
sds_pmmrf_tryout <- syn_experiment(method="rf", index_round=3, method_list, bindori_dataset_threshold_chr, arg_method = arg_method, arg_col=arg_col)
# tryout for pmm_bag
sds_pmmbag_tryout <- syn_experiment(method="bag", index_round=4, method_list, bindori_dataset_threshold_chr, arg_method = arg_method, arg_col=arg_col)
# tryout for pmm_polyreg
sds_pmmpolyreg_tryout <- syn_experiment(method="polyreg", index_round=1, method_list, bindori_dataset_threshold_chr, arg_method = arg_method)
