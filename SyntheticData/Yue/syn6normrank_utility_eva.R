...
learners_list_normrank <- lrns(c("classif.multinom", "classif.ranger"))  # classif.lda excluded
...
bm_models_normrank$aggregate(msr("classif.acc"))[learner_id=="classif.ranger",]
