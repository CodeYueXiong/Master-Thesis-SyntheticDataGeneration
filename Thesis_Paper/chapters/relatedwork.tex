...
additionally modelled without the help of spatial information. (\textcolor{red}{whether or not to include the specific types of GANs})
...
Inspired by learning multiple imputation (MI) for nonresponse \citet{little2019statistical}, 
