...
```{r}
compare(object = data.frame(weight = syn_data_filtered2["weight"]),
        data = data.frame(weight = bindori_dataset_filtered2["weight"]),
        vars = c("weight"), cont.na = NULL,
        msel = NULL, stat = "percents", breaks = 10,
        nrow = 2, ncol = 2, rel.size.x = 1,
        utility.stats = c("pMSE", "S_pMSE"),
        cols = c("#1A3C5A","#4187BF"),
